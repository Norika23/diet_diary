	...
	<div class="retweet-popup-body-wrap">
		...
		<div class="retweet-popup-footer"> 
			<div class="retweet-popup-footer-right">
				<button class="retweet-it" data-tweet="<?php echo $tweet['tweetID'];?>" data-user="<?php echo $tweet['id'];?>" type="submit"><i class="fa fa-retweet" aria-hidden="true"></i>Retweet</button>
			</div>
		</div>
	</div>
</div>
