$(function(){
	$(document).on('click', '.deleteTweet', function(){
		...
		$.post('http://localhost/diet/ajax/deleteTweet.php', {showpopup:tweet_id}, function(data){
			// alert(data);
	...
	$(document).on('click','.delete-it', function(){
		...
		$.post('http://localhost/diet/ajax/deleteTweet.php', {deleteTweet:tweet_id}, function(){
			$('.retweet-popup').hide();
