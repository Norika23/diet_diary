...
for ( $day = 1; $day <= $day_count; $day++, $youbi++) {
    ...
    $meal = $database->query("SELECT * FROM meal WHERE user_id = $user->id AND date = '$this_month/$dday'");
    $sum_calorie = 0;
    ...
    if ($today == $date) {
        ...
        $week .= "<td class='today'><h4><a href='show.php?day=$this_month/$dday'>" . $day;
    } else {
        ...
        $week .= "<h4><a href=show.php?day=$this_month/$dday>" . $day;
