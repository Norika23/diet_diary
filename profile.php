...
include("includes/navbar.php");
 ...
 if (isset($_GET['username']) === true && empty($_GET['username']) === false) {
  ...
  $profileData = $getFromT->userData($profileId);
...
<html>
	<head>
	<title><?php echo $profileData['username'].' (@'.$profileData['username'].')'; ?></title>
	<meta charset="UTF-8" />
		...
		<div class="nav-left">
			<ul>
				 <li><a href="<?php echo BASE_URL; ?>home.php"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li>
      			 ...
      			 <?php if($session->is_signed_in() === true){ ?>
...
<div class="profile-nav">
 <div class="profile-navigation">
	...
	<div class="edit-button">
		<span>
			<?php echo $getFromF->followBtn($profileId, $user_id, $profileData['id']); ?>
 		</span>
	</div>
    </div>
</div>
		     ...
		     '.(($retweet['retweetID'] === $tweet['retweetID'] OR $tweet['retweetID'] > 0) ? '
		      ...
		      <div class="t-show-popup" data-tweet="'.$tweet['tweetID'].'">
		        <div class="t-show-head">
		          ...
		          <div class="t-s-head-content">
		            <div class="t-h-c-name">
		              <span><a href="'.$tweet['username'].'">'.$tweet['username'].'</a></span>
		              <span>@'.$tweet['username'].'</span>
		              <span>'.$getFromU->timeAgo($tweet['postedOn']).'</span>
		            </div>
		            <div class="t-h-c-dis">
